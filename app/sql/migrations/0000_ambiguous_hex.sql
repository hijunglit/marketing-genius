...
ALTER TABLE "request_contents" ADD CONSTRAINT "request_contents_contents_id_contents_contents_id_fk" FOREIGN KEY ("contents_id") REFERENCES "public"."contents"("contents_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "request_contents" ADD CONSTRAINT "request_contents_profile_id_profiles_profile_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "request_contents" ADD CONSTRAINT "request_contents_ai_id_ai_ai_id_fk" FOREIGN KEY ("ai_id") REFERENCES "public"."ai"("ai_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
